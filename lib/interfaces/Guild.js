 ...
 * @prop {number} afkTimeout
 * @prop {string} applicationID
 * @prop {boolean} available
 * @prop {string} banner
 * @prop {Map<string, GuildChannel>} channels
 * @prop {number} defaultMessageNotifcations
 * @prop {string} description
 * @prop {string} embedChannelID
 * @prop {boolean} embedEnabled
 * @prop {Map<string, Emoji>} emojis
 * @prop {number} explicitContentFilter
 * @prop {string[]} features
 * @prop {string} icon
 * @prop {string} id
 * @prop {number} maxMembers
 * @prop {number} maxPresences
 * @prop {number} memberCount
 * @prop {Map<string, Member>} members
 * @prop {number} mfaLevel
 * @prop {string} name
 * @prop {Member} owner
 * @prop {string} preferredLocale
 * @prop {number} premiumSubscriptionCount
 * @prop {number} premiumTier
 * @prop {string} region
 * @prop {Map<string, Role>} roles
 * @prop {number} shardID
 * @prop {string} splash
 * @prop {number} systemChannelFlags
 * @prop {string} systemChannelID
 * @prop {string} vanityURLCode
 * @prop {number} verificationLevel
 * @prop {boolean} widgetEnabled
 * @prop {string} widgetChannelID
 */
